...
public class user_registration1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel3.setFont(new java.awt.Font("Tahoma", 3, 18)); // NOI18N
        ...
        jTextField1.setInputVerifier(new FIRSTNAME());

        jTextField2.setInputVerifier(new lastname());

        jTextField3.setInputVerifier(new age()
        );

        jTextField4.setInputVerifier(new email_id());

        jTextField5.setInputVerifier(new DATEOFBIRTH());

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "CHOOSE ANY ONE", "BTECH", "MBA", "POLY" }));
        jComboBox1.setInputVerifier(new COURSE());
